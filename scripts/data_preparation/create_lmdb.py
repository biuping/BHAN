...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = '../../datasets/DF2K/HR_train_sub'
    lmdb_path = '../../datasets/DF2K/DF2K_train_HR_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = '../../datasets/DF2K/LR_train/X2_sub'
    lmdb_path = '../../datasets/DF2K/LR_train/DF2K_train_LR_X2_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '../../datasets/DF2K/LR_train/X3_sub'
    lmdb_path = '../../datasets/DF2K/LR_train/DF2K_train_LR_X3_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = '../../datasets/DF2K/LR_train/X4_sub'
    lmdb_path = '../../datasets/DF2K/LR_train/DF2K_train_LR_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
