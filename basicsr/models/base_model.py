...
class BaseModel():
    ...
    def __init__(self, opt):
        ...
        self.device = torch.device('cuda:{}'.format(opt['gpu_ids'])) if opt['num_gpu'] != 0 else torch.device('cpu')
    ...
    def generate(self, dataloader, current_iter):
        self.generate_hr(dataloader, current_iter)
